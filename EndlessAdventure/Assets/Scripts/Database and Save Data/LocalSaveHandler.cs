...
public static class LocalSaveHandler
{
        /// <summary>
        ...
        public static void SaveData(object objectToSave, string fileName)
        {
            ...
            string FullFilePath = Path.Combine(Application.persistentDataPath, fileName + ".bin");
            Debug.Log(Path.Combine(Application.persistentDataPath, fileName + ".bin"));
